...
impl Mortgage {
    ...
    fn principal_remaining(&self, months: i32, monthly_payment: i64) -> i64 {
        let mut current_principal: i64 = self.original_principal;
        for i in 0..months {
            println!("{} {:?}", i, current_principal);
            current_principal =
                compound_formula(current_principal, self.interest_rate) - monthly_payment;
        }
        cmp::max(current_principal, 0)
    }
    ...
    fn total_payout(&self, months: i32, monthly_payment: i64) -> i64 {
        months as i64 * monthly_payment as i64
    }
...
mod test {
    ...
    #[test]
    fn test_compound() {
        assert_eq!(compound_formula(100, 0.12), 101);
        assert_eq!(compound_formula(100, 0.06), 101);
        assert_eq!(compound_formula(100, 0.24), 102);
    }
    ...
    fn test_mortgage_principal_remaining() {
        ...
        // assert_eq!(mortgage.principal_remaining(0, monthly_payment), 800_000);
